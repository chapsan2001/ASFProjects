  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            title: Text('Help'),
            actions: <Widget>[
              IconButton(                               //This button leads to page about the app
        ...
        body: ListView(
          ...
          children: <Widget>[
            Column(
              ...
              children: <Widget>[
                SizedBox(height: 5),
                Text('This app is a calculator. What can it do?', style: TextStyle(fontSize: 25)),
                SizedBox(height: 5.0),
                ...
                SizedBox(height: 5.0),
                Text('      8. Calculate trigonometric functions. Enter a number, choose between radians and degrees by tapping "Rad" or "Deg" switch, then press "sin", "cos", "tan", "cot", "sec" or "csc" button. You will get value of a corresponding function.', style: TextStyle(fontSize: 20)),
                SizedBox(height: 5.0),
                ...
                SizedBox(height: 5.0),
                Text('      10. Convert numbers between number systems from 2 to 32. Press "Number systems converter" button on the top of the screen, select number systems, enter a number, then tap "OK" button on the keyboard. You will get entered number in the different number system.', style: TextStyle(fontSize: 20)),
                SizedBox(height: 5.0),
                Text('There is a lot of space above the function buttons. It means that probably new functions will be added later.', style: TextStyle(fontSize: 20)),
                Text('', style: TextStyle(fontSize: 20)),
                Text('Attention! This calculator operates with up to 15-digit numbers.', style: TextStyle(fontSize: 20)),
                Text('', style: TextStyle(fontSize: 20)),
